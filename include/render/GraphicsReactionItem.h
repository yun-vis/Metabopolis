#ifndef GraphicsReactionItem_H
#define GraphicsReactionItem_H
...
//	Class definition
//------------------------------------------------------------------------------
class GraphicsReactionItem : public  QGraphicsRectItem
{
private:
...
public:
    explicit GraphicsReactionItem( QGraphicsItem *parent = Q_NULLPTR );
    explicit GraphicsReactionItem( const QRectF &rect, QGraphicsItem *parent = Q_NULLPTR );
    explicit GraphicsReactionItem( qreal x, qreal y, qreal w, qreal h, QGraphicsItem *parent = Q_NULLPTR );
    ~GraphicsReactionItem();
